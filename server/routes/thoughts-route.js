...
/**
 * URL: localhost:8001/api/thought/seed
...
router.post('/seed', (req, res, next) => {
    ...
    res.send('Lets run the GET after this to se if the thoughts got seeded properly  ');
});

/**
 * URL: localhost:8001/api/thoughts/create
